# API construída para o projeto "Mente Sã" da jornada Dev For Tech da Gama Academy!
...
```bash
git clone --depth 1 https://github.com/jiuneypachevitch/mente-sa-backend-api
cd mente-sa-api
rm -rf .git
```
...
#### Setar, nas variáveis de ambiente a url de conexão com mongodb no arquivo `.env`
`MONGO_URI`
`MONGO_URI_TESTS`
...
# Based in Express ES2017 REST API Boilerplate
